...
public slots:
    void mousePressed(QMouseEvent * event);         //when cueball is pressed, before shooting the white ball all the ball states will be saved by calling the saveState() function of the poolgame class.
