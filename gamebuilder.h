...
public:
    ...
    void addBallGroup(const QJsonObject &ballGroupJSon,const QJsonObject &tableJSon);      /*The function requires data from the table to location the ball group in the middle by default.
                                                                                                                                                                                       */
